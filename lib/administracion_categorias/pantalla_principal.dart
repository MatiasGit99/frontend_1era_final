...
import '/administracion_categorias/actions.dart';
import '/administracion_categorias/pantalla_agregar.dart';
import '/administracion_categorias/pantalla_editar.dart';
import '/main.dart';
...
class _AdministracionCategoriasScreenState
  ...
  Future<void> insertCategoria() async {
    final nuevaCategoria =
        Categoria(idCategoria: null, nombre: 'Nueva Categoría');
  ...
  void exportToExcel(List<Categoria> data) async {
    ...
    for (final categoria in data) {
      sheet.appendRow([categoria.idCategoria, categoria.nombre]);
    }
          ...
          build: (context) {
            return pw.Column(
              children: [
                ...
                pw.Text('Descripción: ${categoria.nombre}'),
                pw.Divider(),
              ],
            );
          },
                        ...
                        onPressed: () {
                          ...
                          final categoriaAEditar = Categoria(
                            idCategoria: categoria
                                .idCategoria, // asigna el ID de la categoría que deseas editar,
                          ...
                          Navigator.of(context)
                            ...
                            return EditarCategoriaScreen(
                                categoria:
                                    categoriaAEditar); // Pasa la categoría a editar a la pantalla de edición
                          }));
                        },
                      ),
                      IconButton(
